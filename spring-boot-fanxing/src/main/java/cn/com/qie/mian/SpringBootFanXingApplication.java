...
public class SpringBootFanXingApplication {

    // 标准的JAVA应用main方法，主要作用作为项目启动的入口
	public static void main(String[] args) {
//		SpringApplication.run(SpringBootStudentBannerApplication.class, args);
		SpringApplication application = new SpringApplication(SpringBootFanXingApplication.class);
		/*
		 * Mode.OFF:关闭; 
